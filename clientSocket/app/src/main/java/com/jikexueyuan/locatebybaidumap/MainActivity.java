...
//设置为普通地图（默认可以不用设置,其它是卫星图与无地图）
//        mBaiduMap.setMapType(BaiduMap.MAP_TYPE_NORMAL);
//定位服务端设置及开启
        mLocationClient = new LocationClient(getApplicationContext());     //声明LocationClient类
        mLocationClient.registerLocationListener(myListener);//注册监听函数->将myListener对象注册到监听函数中
        initLocation();
    ...
    protected void onDestroy() {
        ...
        mLocationClient.unRegisterLocationListener(myListener);    //取消之前注册的定位监听函数（对象）
...
//        }
    ...
    // 设置定位数据,第二个参数是MyLocationConfiguration类型。// TODO: 2016/5/26 方向设置等
